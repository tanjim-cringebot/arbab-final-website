...
const ContactInfo = ({ icon: Icon, title, info }) => (
  ...
  >
    <motion.div
      className="bg-blue-900 rounded-full p-4 mb-3"
      whileHover={{ scale: 1.1, rotate: 360 }}
      transition={{ duration: 0.3 }}
    >
    ...
    <p className="text-lg text-gray-300">{info}</p>
  </motion.div>
);
    ...
    <main className="relative min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-black overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          {/* Let's Collaborate */}
          <section className="mt-24 relative overflow-hidden py-16">
            ...
            <div className="relative z-10 container mx-auto px-4">
              <motion.div 
                ...
                transition={{ duration: 0.5 }}
              >
                <h3 className="text-3xl font-bold mb-6 text-white">Ready to Transform Your Packaging?</h3>
              </motion.div>
              ...
              >
                <Link
                  href="/contact"
                  className="inline-flex items-center space-x-2 bg-blue-600 text-white px-6 py-3 rounded-full text-xl font-semibold hover:bg-blue-700 transition duration-300 group"
                >
